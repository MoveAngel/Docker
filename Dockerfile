FROM ubuntu:groovy
LABEL maintainer "MoveAngel <moveangel@minaproject.tech>"
...
RUN pip3 install -r https://raw.githubusercontent.com/MoveAngel/One4uBot/sql-extended/requirements.txt requirements.txt
